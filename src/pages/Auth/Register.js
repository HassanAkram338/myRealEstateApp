...
export default function Register() {
  ...
  return (
    ...
    >
      <div class="p-4 py-4 bg-slate-400 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly">
        ...
        <form onSubmit={handleSubmit} class="flex flex-col space-y-5">
          ...
          <div class="flex flex-col space-y-5">
            <span class="flex items-center justify-center space-x-2">
              ...
              <span className="font-normal text-gray-500 text-center">Already have an account?<Link to='/auth/login'>Login</Link></span>
